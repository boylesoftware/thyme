...
import com.boylesoftware.web.ForbiddenException;
import com.boylesoftware.web.RequestedResourceException;
import com.boylesoftware.web.spi.Script;


/**
 * Implementation of the "forbid if/unless" script statement.
 *
 * @author Lev Himmelfarb
 */
class ForbidStatement
	implements Script {
	 ...
	 * value. That is {@code true} for "forbid if" and {@code false} for "forbid
	 * unless".
	 * @param condition Condition to evaluate.
	 */
	ForbidStatement(final boolean expectedConditionResult,
